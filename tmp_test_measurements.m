...
tmp_name="tmp_test_measurements";
...
%     %%%%%%%%%%%%%%%%%%%%%
    ...
    botrace0.times=0;
    save(append(dir, 'y_offset_',num2str(counter),'.mat'),'y_offset');
    save(append(dir, 'u_offset_',num2str(counter),'.mat'),'u_offset');    
    save(append(dir, 'G2data_',num2str(counter),'.mat'),'G2data');
    save(append(dir, 'botrace0_',num2str(counter),'.mat'), 'botrace0');
    save(append(dir, 'gains0_',num2str(counter),'.mat'), 'gains0');
    save(append(dir, 'perf_Data_',num2str(counter),'.mat'), 'perf_Data');
    save(append(dir, 'exp_Data_',num2str(counter),'.mat'), 'exp_Data');
end
counter=counter+1;
if counter>500
    expr=expr+1;
