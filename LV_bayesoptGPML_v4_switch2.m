function [minsample,minvalue,botrace,LVgains, hyper_grid, idx_G2, G2, counter_s,when_switch_s, debug_ratio, ys] = LV_bayesoptGPML_v4_switch2(Obj,opt, hyper_grid,counter_s,G2data,idx_G2,when_switch_s, counter_real)
