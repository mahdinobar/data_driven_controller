...
% GBO version 4_2 (keep only last surrogate)
...
fun = @(X, surrogate)ObjFun_Guided_v4_2(X, surrogate);
...
for expr=1:1:N_expr
    ...
    [ms,mv,Trace_tmp] = LM_bayesoptGPML_v4_2(fun,opt,N0);
...
%%
function [objective, N_G2] = ObjFun_Guided_v4_2(X, surrogate)
global N
global G2data
global N_G2
